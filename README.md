...
![PT01 product label](evidence/offline-remote-reconnect.jpeg)

The supplied label image is included at the requested public path. It identifies the unit as model PT01 and shows the full hardware serial, which the owner explicitly approved for publication. See [evidence/README.md](evidence/README.md).
...
- [evidence/](evidence/) — photographs and screen evidence used in the report.
